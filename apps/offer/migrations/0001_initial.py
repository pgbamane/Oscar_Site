...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(verbose_name='Name', unique=True, max_length=128, help_text="This is displayed within the customer_12's basket")),
                ...
                ('offer_type', models.CharField(default='Site', max_length=128, verbose_name='Type', choices=[('Site', 'Site offer - available to all users'), ('Voucher', 'Voucher offer - only available after entering the appropriate voucher code'), ('User', 'User offer - available to certain types of customer_final'), ('Session', 'Session offer - temporary offer, available for a customer_final for the duration of their session')])),
                ...
                ('max_user_applications', models.PositiveIntegerField(verbose_name='Max customer_final applications', blank=True, help_text='The number of times a single customer_final can use this offer', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=False, verbose_name='Is public?', help_text='Public ranges have a customer_12-facing page')),
